...
#進捗トリガー
execute if entity @e[type=armor_stand,tag=rng,scores={end_count=1}] unless entity @a[tag=success_escape] as @a[team=lord] at @s run function thiefgame:advancement/trigger/win_ability/check_ability
