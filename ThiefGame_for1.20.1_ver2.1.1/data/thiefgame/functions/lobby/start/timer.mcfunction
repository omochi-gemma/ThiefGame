...
##進捗トリガー
execute if entity @e[type=armor_stand,tag=rng,tag=timer,scores={timer=..0,timer_minute=0,timer_second=0}] unless entity @a[tag=success_escape] run advancement grant @a[team=lord] only thiefgame:achievements/lord/dawn
