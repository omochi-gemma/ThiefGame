...
execute if entity @s[scores={start_count=80}] run tellraw @a[team=thief] [{"text": "[MISSION] ","color": "yellow"},{"text": "2階の鍵","hoverEvent": {"action": "show_text","contents": "屋上のチェストから入手"},"underlined": true,"color": "white"},{"text": "で2階を解放しよう！","color": "white"}]
