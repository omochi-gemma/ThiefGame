...
scoreboard objectives add slot_rng dummy
...
#参加人数
scoreboard objectives add joined_player_count dummy
#準備完了人数
...
scoreboard objectives add revenge_over_count dummy
#時間魔術師
...
#進捗トリガー関連
scoreboard objectives add adv_on_time_leave dummy
scoreboard objectives add adv_troublesome dummy
