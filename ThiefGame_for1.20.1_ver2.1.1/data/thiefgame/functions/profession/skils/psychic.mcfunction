...
execute if entity @s[nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{CustomModelData:3}}},scores={use_carrot3=1}] run summon armor_stand ^ ^1 ^16 {NoGravity:1b,Silent:1b,Invulnerable:1b,Marker:1b,Invisible:1b,Tags:["super_eye","last_super_eye"]}
...
execute if entity @s[nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{CustomModelData:3}}},scores={use_carrot3=1}] as @e[type=armor_stand,tag=super_eye] at @s run effect give @a[team=lord,distance=..2] slowness 7 4 true

#進捗トリガー
execute if entity @s[nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{CustomModelData:3}}},scores={use_carrot3=1}] at @e[type=armor_stand,tag=last_super_eye] if entity @a[team=lord,distance=..2] run advancement grant @s only thiefgame:achievements/thief/vision_test
...
execute if entity @s[nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{CustomModelData:4}}},scores={use_carrot4=1}] run effect give @a[team=lord] glowing 10 0 true
