...
execute if entity @s[nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{CustomModelData:7}}},scores={use_carrot7=1}] run particle dust 1 0.373 0.102 1 ~ ~1 ~ 0.2 0.2 0.2 1 100 force @a[team=thief]
