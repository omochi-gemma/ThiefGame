...
scoreboard players set @a[tag=avenger] revenge_over_count 0
execute if entity @s[tag=avenger] run scoreboard players add @s revenge 1
...
advancement revoke @s only thiefgame:system/thief_damage