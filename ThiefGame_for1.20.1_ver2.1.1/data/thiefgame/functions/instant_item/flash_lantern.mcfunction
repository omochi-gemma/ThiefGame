#フラッシュランタン
execute if entity @s[team=thief,nbt={SelectedItem:{id:"minecraft:warped_fungus_on_a_stick",tag:{CustomModelData:1}}},scores={use_fungs1=1}] if entity @a[team=lord,distance=..7] run advancement grant @a[team=lord,distance=..7] only thiefgame:system/lord_attack
