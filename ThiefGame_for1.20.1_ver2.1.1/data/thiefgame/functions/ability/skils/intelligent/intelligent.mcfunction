...
execute as @e[tag=bloodstain_interaction] on target at @s if entity @s[team=lord,tag=intelligent] run effect give @a[team=thief] glowing 7 0 true
execute as @e[tag=bloodstain_interaction] on target at @s if entity @s[team=lord,tag=intelligent] run effect give @s[team=lord] invisibility 7 0 true
