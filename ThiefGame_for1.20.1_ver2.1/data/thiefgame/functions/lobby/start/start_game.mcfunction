...
scoreboard players set @a use_carrot7 0
scoreboard players set @a use_carrot8 0
scoreboard players set @a use_carrot9 0
...
summon interaction 84 39 60.3 {Tags:["ready_interaction"]}
summon interaction 82 39 60.3 {Tags:["ready_cancel_interaction"]}
summon interaction 78 39 60.3 {Tags:["ready_interaction"]}
summon interaction 76 39 60.3 {Tags:["ready_cancel_interaction"]}
