...
execute if entity @e[type=armor_stand,tag=landmine,scores={landmine_time=1200..}] run tellraw @s "地雷が壊れてしまった...。"
kill @e[type=armor_stand,tag=landmine,scores={landmine_time=1200..}]
...
execute if entity @e[type=armor_stand,tag=landmine_warp,scores={landmine_warp_time=2400..}] run tellraw @s "ワープ地点が壊れてしまった...。"
execute as @e[type=armor_stand,tag=landmine_warp,scores={landmine_warp_time=2400..}] run kill @s
