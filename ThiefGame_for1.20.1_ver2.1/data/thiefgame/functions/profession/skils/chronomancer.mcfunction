...
#シェーダーを終了
execute if entity @s[scores={timestop_count=-1}] as @a[team=lord] at @s run particle minecraft:entity_effect ~ ~ ~ 0.9960784313725490196078431372549 0.9921568627450980392156862745098 1 1 0 force @s
execute if entity @s[scores={timestop_count=-1}] as @a[team=thief] at @s run particle minecraft:entity_effect ~ ~ ~ 0.9960784313725490196078431372549 0.9921568627450980392156862745098 1 1 0 force @s
#演出
execute if entity @s[nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{CustomModelData:9}}},scores={use_carrot9=1}] run playsound block.bell.use master @a ~ ~ ~ 1 0 1
execute if entity @s[nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{CustomModelData:9}}},scores={use_carrot9=1}] as @a at @s run particle firework ~ ~1 ~ 0.8 0.2 0.8 0.5 100 force @a
#処理
##使用回数を記録
