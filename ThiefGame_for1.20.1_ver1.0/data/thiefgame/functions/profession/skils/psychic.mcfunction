...
execute if entity @s[scores={super_eye_time=..-1}] run scoreboard players set @s super_eye_time 40
...
execute if entity @s[nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{CustomModelData:4}}},scores={use_carrot4=1}] if entity @a[team=lord,distance=..10] run effect give @s glowing 10 0 true
...
execute if entity @s[scores={clairvoyance_time=..-1}] run scoreboard players set @s clairvoyance_time 60