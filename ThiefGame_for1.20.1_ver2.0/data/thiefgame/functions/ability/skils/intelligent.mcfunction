...
execute as @e[tag=bloodstain_interaction] on target at @s run effect give @a[team=thief] glowing 5 0 true
execute as @e[tag=bloodstain_interaction] on target at @s run effect give @s[team=lord] invisibility 5 0 true
execute as @e[tag=bloodstain_interaction] on target at @s run playsound block.enchantment_table.use master @a ~ ~ ~ 1 1.2 0
execute as @e[tag=bloodstain_interaction] on target at @s run particle enchant ~ ~ ~ 0.4 0.4 0.4 1 500 force @a