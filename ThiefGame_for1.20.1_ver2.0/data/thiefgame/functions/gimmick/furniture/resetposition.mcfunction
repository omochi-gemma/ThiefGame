...
#バリアブロックを破壊
function thiefgame:gimmick/furniture/break_allbarrierblock
...
###1階
####椅子1
tp @e[tag=chair1a_1] -8.25 38.75 209.5
summon interaction -8.25 39.75 209.5 {Tags:["place_interaction","chair1a_1_place_interaction"],width:1.0f,height:1.0f}
###2階
####ソファ1
tp @e[tag=sofa2a_1] -13.0 43.5 224.0
summon interaction -13.0 44.5 224.0 {Tags:["place_interaction","sofa2a_1_place_interaction"],width:1.0f,height:1.0f}
####椅子1
tp @e[tag=chair2a_1] 8.5 43.75 223.5
summon interaction 8.5 44.75 223.5 {Tags:["place_interaction","chair2a_1_place_interaction"],width:1.0f,height:1.0f}
####長机1
tp @e[tag=longtable2a_1] 7.0 44.0 202.75
summon interaction 7.0 44.0 202.75 {Tags:["place_interaction","longtable2a_1_place_interaction"],width:1.0f,height:1.0f}