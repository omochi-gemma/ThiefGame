...
execute if entity @e[type=armor_stand,tag=landmine,scores={landmine_time=6000..}] run tellraw @s "地雷が壊れてしまった...。"
...
execute if entity @e[type=armor_stand,tag=landmine_warp,scores={landmine_warp_time=12000..}] run tellraw @s "ワープ地点が壊れてしまった...。"
